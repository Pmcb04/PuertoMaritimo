...
public class Gasolinera {
	...
	private static CyclicBarrier barcosEsperando; 
	...
	Gasolinera(int numPetroleros){
		...
		barcosEsperando = new CyclicBarrier(numPetroleros);
	...
	public static void llegar(BarcoPetrolero b) {
		...
		FileBarcos.print("N�mero de barcos esperando a repostar: " + barcosBloqueados);
		mutex.release();
		try {
			barcosEsperando.await(); // esperamos a que todos los barcos hayan entrado a la gasoliner
	...
	public static void repostarAgua(BarcoPetrolero b) {
		...
		b.addAgua(repostajeAgua); // añadimos en cada carga repostajeAgua litros de agua
