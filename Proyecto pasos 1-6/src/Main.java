...
public class Main {
	...
	private static final int BARCOS_ENTRADA = 10; // n�mero de barcos de entrada
	private static final int BARCOS_SALIDA = 10; // n�mero de barcos de salida
	private static final int BARCOS_MERCADER = 1; // n�mero de barcos mercaderes
	private static final int BARCOS_PETROLEROS = 5; // n�mero de barcos petroleros
	private static final int PLATAFORMAS = 1; // n�mero de plataformas
	private static final int GASOLINERAS = 1; // n�mero de gasolineras
	private static final int REPONEDORES = 1; // n�mero de reponedores
	private static final int GRUAS = 3; // n�mero de gruas
	...
	public static void main(String args[]) throws IOException {
		...
		for (int i = 0; i < BARCOS_PETROLEROS; i++) { // barcos petroleros de entrada
			vBarcosPetroleros[i] = new BarcoPetrolero(i+200,3000,5000);
